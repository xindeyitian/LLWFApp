...
@interface ChangeInfoHeaderView()

@property (strong, nonatomic) MyLinearLayout *rootLy;

@end

@implementation ChangeInfoHeaderView
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self layoutIfNeeded];
        UIBezierPath *maskPath1 = [UIBezierPath bezierPathWithRoundedRect:self.rootLy.bounds   byRoundingCorners:UIRectCornerTopLeft   |   UIRectCornerTopRight    cornerRadii:CGSizeMake(8, 8)];
