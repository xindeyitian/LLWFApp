...
@interface EarningTopView()<FiltratePopViewDelegate>
...
- (void)initCustomView{
    ...
    self.earningLable.myWidth = self.earningLable.myHeight = MyLayoutSize.wrap;
