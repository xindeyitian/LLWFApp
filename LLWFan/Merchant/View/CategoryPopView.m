...
- (void)popCategroyView{
    ...
    LSTPopView *popView = [LSTPopView initWithCustomView:self parentView:self.currentViewController.view popStyle:LSTPopStyleSmoothFromTop dismissStyle:LSTDismissStyleSmoothToTop];
