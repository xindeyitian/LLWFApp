...
@interface ShopCarRecommendCell()<UICollectionViewDelegate,UICollectionViewDataSource,THFlowLayoutDelegate>
...
@implementation ShopCarRecommendCell
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.dataArr) {
        ...
        [cell setItemWithGuessModel:self.dataArr[indexPath.item]];
    }
    return cell;
}
...
- (CGFloat)waterflowLayout:(THFlowLayout *)waterflowLayout heightForWidth:(CGFloat)width atIndexPath:(NSIndexPath *)indexPath{
    ...
    GoodsListModel *model = self.dataArr[indexPath.item];
    return model.height;
}
#pragma mark - getter
