...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self layoutIfNeeded];
        UIBezierPath *maskPath1 = [UIBezierPath bezierPathWithRoundedRect:self.rootLy.bounds   byRoundingCorners:UIRectCornerBottomLeft   |   UIRectCornerBottomRight    cornerRadii:CGSizeMake(10, 10)];
