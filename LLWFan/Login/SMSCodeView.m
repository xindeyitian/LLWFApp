...
- (void)config {
    ...
    _label.font = [UIFont fontWithName:@"DIN-Medium" size:24];
...
- (void)layoutSubviews {
    ...
    self.bgView.frame = CGRectMake(0, self.frame.size.height/2.0 - self.frame.size.width/2.0, self.frame.size.width, self.frame.size.width);
    ...
    self.label.center = self.bgView.center;
